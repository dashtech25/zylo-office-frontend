...
const contentVariants = cva("fixed z-50 bg-surface shadow-elevated transition-[opacity,transform] duration-200 data-[state=closed]:opacity-0", {
  variants: {
    size: {
      sm: "left-1/2 top-1/2 w-full -translate-x-1/2 -translate-y-1/2 rounded-card p-6 overflow-y-auto max-w-sm max-h-[calc(100vh-6rem)] data-[state=closed]:scale-95",
      md: "left-1/2 top-1/2 w-full -translate-x-1/2 -translate-y-1/2 rounded-card p-6 overflow-y-auto max-w-md max-h-[calc(100vh-6rem)] data-[state=closed]:scale-95",
      lg: "left-1/2 top-1/2 w-full -translate-x-1/2 -translate-y-1/2 rounded-card p-6 overflow-y-auto max-w-2xl max-h-[calc(100vh-6rem)] data-[state=closed]:scale-95",
      xl: "left-1/2 top-1/2 w-full -translate-x-1/2 -translate-y-1/2 rounded-card p-6 overflow-y-auto max-w-4xl max-h-[calc(100vh-6rem)] data-[state=closed]:scale-95",
