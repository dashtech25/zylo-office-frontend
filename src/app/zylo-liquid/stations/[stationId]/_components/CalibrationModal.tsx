...
import { listTankCalibrationPoints, replaceTankCalibrationPoints, type CalibrationPoint, type Tank } from "@/core/api/zyloLiquid";
                ...
                {points
                  ...
                  .map((p, i) => (
                    <tr key={i} className="border-b border-border-subtle/60">
                      ...
                      <td className="p-2 text-right tabular-nums">{p.volumeLiters.toLocaleString()} L</td>
                    </tr>
                  ))}
              </tbody>
            </table>
